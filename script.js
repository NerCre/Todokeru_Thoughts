...
(() => {
  ...
  const DEFAULT_STAFF = [
    { id: 'S001', name: '佐藤 一郎', kana: 'さとう いちろう', affiliation: '自社', birthday: '', blood: '', history: [], meds: [], allergies: [], doctor: '', contactRel: '', contactTel: '' },
    { id: 'S002', name: '高橋 花子', kana: 'たかはし はなこ', affiliation: '自社', birthday: '', blood: '', history: [], meds: [], allergies: [], doctor: '', contactRel: '', contactTel: '' },
    { id: 'S003', name: '山田 太郎', kana: 'やまだ たろう', affiliation: 'A造船', birthday: '', blood: '', history: [], meds: [], allergies: [], doctor: '', contactRel: '', contactTel: '' },
